...
[![GitHub stars](https://img.shields.io/github/stars/romejiang/nas-tools?style=plastic)](https://github.com/romejiang/nas-tools/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/romejiang/nas-tools?style=plastic)](https://github.com/romejiang/nas-tools/network/members)
[![GitHub issues](https://img.shields.io/github/issues/romejiang/nas-tools?style=plastic)](https://github.com/romejiang/nas-tools/issues)
[![GitHub license](https://img.shields.io/github/license/romejiang/nas-tools?style=plastic)](https://github.com/romejiang/nas-tools/blob/master/LICENSE.md)
[![Docker pulls](https://img.shields.io/docker/pulls/romejiang/nas-tools?style=plastic)](https://hub.docker.com/r/romejiang/nas-tools)
[![Platform](https://img.shields.io/badge/platform-amd64/arm64-pink?style=plastic)](https://hub.docker.com/r/romejiang/nas-tools)


Docker：https://hub.docker.com/repository/docker/romejiang/nas-tools

TG频道：https://t.me/nastool

WIKI：https://github.com/romejiang/nas-tools/wiki
...
### 1、Docker
```
docker pull romejiang/nas-tools:latest
```
...
```
git clone -b master https://github.com/romejiang/nas-tools --recurse-submodule 
...
https://github.com/romejiang/nas-tools/releases
